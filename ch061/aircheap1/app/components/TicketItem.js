...
class TicketItem extends Component {
    render() {
        ...
        let departureTime = new Date(ticket.segment[0].departureTime).toLocaleDateString('eu-US', dateConfig);
        let arrivalTime = new Date(ticket.segment[0].arrivalTime).toLocaleDateString('eu-US', dateConfig);
